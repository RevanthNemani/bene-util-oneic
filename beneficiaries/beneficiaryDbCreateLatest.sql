...
START TRANSACTION;
USE `BENEFICIARY_DB`;
INSERT INTO `BENEFICIARY_DB`.`COMPANY_MASTER` (`COMPANY_ID`, `COMPANY_NAME`, `WEB_URL`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`) VALUES (1, 'OMANTEL', 'http://www.omantel.com', DEFAULT, DEFAULT, 1);
...
INSERT INTO `BENEFICIARY_DB`.`COMPANY_MASTER` (`COMPANY_ID`, `COMPANY_NAME`, `WEB_URL`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`) VALUES (3, 'OOREDOO', 'http://www.oredoo.com', DEFAULT, DEFAULT, 1);
...
START TRANSACTION;
USE `BENEFICIARY_DB`;
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (1, 2, '0002789', 'OIFC Water', 1, 2000, DEFAULT, DEFAULT, 1, 'BPWT');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (2, 2, '0002789', 'OIFC Electricity', 1, 2000, DEFAULT, DEFAULT, 1, 'BPEC');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (3, 2, '0002789', 'OIFC Renna', 1, 2000, DEFAULT, DEFAULT, 1, 'BPR1');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (4, 2, '0002789', 'OIFC Friendi', 1, 50, DEFAULT, DEFAULT, 1, 'BPF1');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (5, 3, '0002412', 'Ooredo Prepaid', 1, 100, DEFAULT, DEFAULT, 1, 'BPN1');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (6, 3, '0002412', 'Ooredo Postpaid', 1, 2000, DEFAULT, DEFAULT, 1, 'BPN2');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (7, 3, '0002412', 'Ooredoo Fixed Postpaid', 1, 2000, DEFAULT, DEFAULT, 1, 'BPN4');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (8, 3, '0002412', 'Ooredo Fixed Prepaid', 1, 100, DEFAULT, DEFAULT, 1, 'BPN3');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (9, 1, '0002476', 'Omantel Internet', 1, 2000, DEFAULT, DEFAULT, 1, 'BPO4');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (10, 1, '0002476', 'Omantel Fixed Line', 1, 2000, DEFAULT, DEFAULT, 1, 'BPO3');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (11, 1, '0002476', 'Omantel Postpaid', 1, 2000, DEFAULT, DEFAULT, 1, 'BPO2');
INSERT INTO `BENEFICIARY_DB`.`SERVICES` (`SERVICE_ID`, `COMPANY_ID`, `CREDIT_ACCOUNT_NUM`, `SERVICE_NAME`, `MIN_PAY_AMOUNT`, `MAX_PAY_AMOUNT`, `CREATED_ON`, `UPDATED_ON`, `IS_ACTIVE`, `PRD`) VALUES (12, 1, '0002476', 'Omantel Prepaid', 1, 100, DEFAULT, DEFAULT, 1, 'BPO1');
